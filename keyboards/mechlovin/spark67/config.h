...
#define MANUFACTURER Spark
#define PRODUCT      Spark67s
 ...
 *
 */
#define MATRIX_ROW_PINS { B6, B5, B4, B3, B7 }
#define MATRIX_COL_PINS { A4, A5, A6, A7, B0, B1, B10, B11, A8, B15, B14, B13, B12, A9, A10 }
#define UNUSED_PINS
