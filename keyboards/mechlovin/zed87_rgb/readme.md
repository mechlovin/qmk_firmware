...
![zed60](https://i.imgur.com/EHRtIqxh.jpeg)

Zed87 RGB PCB, TKL keyboard PCB.
* Keyboard Maintainer: [Mechlovin'](https://mechlovin.studio)
* Hardware Supported: Zed87 RGB, APM32F103
* Hardware Availability: [Mechlovin'](https://mechlovin.studio)

Make example for this keyboard (after setting up your build environment):

    make mechlovin/zed87_rgb:default

Flashing example for this keyboard:

    make mechlovin/zed87_rgb:default:flash
