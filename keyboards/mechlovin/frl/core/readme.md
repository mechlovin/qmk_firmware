...
A PCB for Core FRL keyboard.

* Keyboard Maintainer: [Mechlovin' Studio](https://mechlovin.studio/)
* Hardware Supported: Core FRL, APM32F103 
* Hardware Availability: [JJW](https://jjwkb.com/pages/designs)

Make example for this keyboard (after setting up your build environment):

    make mechlovin/frl/core:default

Flashing example for this keyboard:

    make mechlovin/frl/core:default:flash
